...
export const StudentGuidancePage: React.FC = () => {
  ...
  return (
    <div className="bg-black text-white min-h-screen w-full select-none selection:bg-white/20 selection:text-white relative">
      ...
      <section className="py-16 sm:py-20 md:py-28 px-4 sm:px-6 bg-zinc-950/40 border-y border-white/5 relative overflow-hidden">
        <div className="max-w-5xl mx-auto relative z-10">
          ...
          <motion.p
            ...
            className="text-white/60 text-xs sm:text-sm md:text-base leading-relaxed max-w-3xl font-light"
          >
          ...
          <div className="grid grid-cols-1 sm:grid-cols-2 lg:grid-cols-3 gap-4 sm:gap-6 md:gap-8">
            {guidanceSteps.map((step, index) => (
              <motion.div
                ...
                className="liquid-glass rounded-3xl p-5 sm:p-6 md:p-8 flex flex-col justify-between group hover:border-white/20 transition-all duration-300"
              >
                <div>
                  <div className="flex items-center justify-between mb-4 sm:mb-6">
                    <span className="w-7 h-7 sm:w-8 sm:h-8 rounded-full bg-white/5 border border-white/10 flex items-center justify-center text-xs font-mono text-white/80 group-hover:bg-white group-hover:text-black transition-colors duration-300">
                      0{step.number}
                    </span>
                    <Sparkles className="w-3.5 h-3.5 sm:w-4 sm:h-4 text-white/20 group-hover:text-white/60 transition-colors" />
                  </div>

                  <h3 className="text-white text-base sm:text-lg md:text-xl font-medium tracking-tight mb-2 sm:mb-3">
                    {step.title}
                  </h3>
      ...
      <section className="py-16 sm:py-20 md:py-28 px-4 sm:px-6 bg-zinc-950/60 border-y border-white/5 relative overflow-hidden text-center">
        <div className="max-w-4xl mx-auto relative z-10">
          <div className="text-white/40 text-xs sm:text-sm tracking-widest uppercase mb-4 sm:mb-6 font-medium">
            What We're Not
          </div>
          <h2 className="text-xl sm:text-2xl md:text-4xl text-white font-normal leading-relaxed tracking-tight mb-4 px-2">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6 md:gap-8">
            {exampleJourneys.map((journey, index) => (
              <motion.div
                ...
                className="liquid-glass rounded-3xl p-5 sm:p-6 md:p-8 flex flex-col justify-between"
              >
                <div>
                  <div className="flex items-center justify-between mb-3 sm:mb-4">
                    <span className="text-[10px] sm:text-[11px] font-semibold tracking-wider uppercase px-2.5 sm:px-3 py-1 rounded-full border bg-blue-500/10 text-blue-300 border-blue-500/20">
                      {journey.tag}
                    </span>
                  ...
                  <div className="mb-3 sm:mb-4">
                    <span className="text-[11px] sm:text-xs text-white/40 uppercase tracking-wider block mb-1">
                      Starting point:
                    </span>
                    <p className="text-white/70 text-xs sm:text-sm italic font-light">
                      {journey.rawIdea}
                    </p>
                  </div>
                ...
                <div className="pt-3 sm:pt-4 border-t border-white/5">
                  <span className="text-[11px] sm:text-xs text-emerald-400/80 uppercase tracking-wider block mb-1 font-semibold">
                    Outcome:
                  </span>
      ...
      <section className="py-16 sm:py-24 md:py-32 px-4 sm:px-6 border-t border-white/5 text-center relative overflow-hidden">
        <div className="max-w-2xl mx-auto relative z-10">
          ...
          <p className="text-white/60 text-xs sm:text-sm md:text-base mb-6 sm:mb-8 max-w-lg mx-auto font-light leading-relaxed px-2">
          ...
          <form onSubmit={handleIdeaSubmit} className="max-w-xl mx-auto mb-6 sm:mb-8">
