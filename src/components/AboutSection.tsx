...
export const AboutSection: React.FC = () => {
  ...
  return (
    <section
      ref={ref}
      id="about"
      className="bg-black pt-20 sm:pt-32 md:pt-44 pb-10 sm:pb-14 px-4 sm:px-6 overflow-hidden relative"
    >
      ...
      <div className="max-w-5xl mx-auto relative z-10 text-center md:text-left">
        ...
        <motion.h2
          ...
          className="text-2xl sm:text-4xl md:text-6xl lg:text-7xl text-white leading-[1.2] sm:leading-[1.15] tracking-tight"
        >
          Building{' '}
        ...
        <div id="manifesto" className="mt-6 sm:mt-8 text-white/60 text-xs sm:text-sm md:text-base max-w-2xl font-light leading-relaxed">
